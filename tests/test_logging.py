...
class TestJSONFormatter:
    ...
    def test_format_basic_record(self, reset_logging: None) -> None:
    ...
    def test_format_with_extra_fields(self, reset_logging: None) -> None:
        ...
        record.created = time.time()
        record.extra_fields = {"error_type": "ValueError", "error_code": 500}
    ...
    def test_format_timestamp_format(self, reset_logging: None) -> None:
    ...
    def test_format_all_log_levels(self, reset_logging: None) -> None:
...
class TestSetupLogger:
    ...
    def test_setup_logger_creates_logger(self, reset_logging: None) -> None:
    ...
    def test_setup_logger_sets_level(self, reset_logging: None) -> None:
    ...
    def test_setup_logger_json_format(self, reset_logging: None) -> None:
    ...
    def test_setup_logger_human_readable_format(self, reset_logging: None) -> None:
    ...
    def test_setup_logger_removes_existing_handlers(self, reset_logging: None) -> None:
    ...
    def test_setup_logger_all_levels(self, reset_logging: None) -> None:
...
class TestGetLogger:
    ...
    def test_get_logger_returns_logger(self, reset_logging: None) -> None:
    ...
    def test_get_logger_returns_same_instance(self, reset_logging: None) -> None:
...
class TestLogContext:
    ...
    def test_log_context_adds_fields(self, reset_logging: None) -> None:
    ...
    def test_log_context_merges_with_existing(self, reset_logging: None) -> None:
    ...
    def test_log_context_resets_after_exit(self, reset_logging: None) -> None:
    ...
    def test_log_context_empty(self, reset_logging: None) -> None:
...
class TestLogApiCall:
    ...
    def test_log_api_call_logs_start(self, reset_logging: None) -> None:
        """Test that log_api_call logs API call start."""
        # Arrange
        logger = setup_logger("test_module")
        logger.info = MagicMock(spec=logging.Logger.info)
    ...
    def test_log_api_call_logs_success(self, reset_logging: None) -> None:
        ...
        success_calls = [
            call for call in logger.info.call_args_list if "completed" in str(call)
        ]
        assert len(success_calls) > 0

    def test_log_api_call_logs_timing(self, reset_logging: None) -> None:
    ...
    def test_log_api_call_logs_error(self, reset_logging: None) -> None:
        """Test that log_api_call logs errors."""
        # Arrange
        logger = setup_logger("test_module")
        logger.info = MagicMock(spec=logging.Logger.info)
        logger.error = MagicMock(spec=logging.Logger.error)
    ...
    def test_log_api_call_preserves_function_signature(
    ...
    def test_log_api_call_with_args_and_kwargs(self, reset_logging: None) -> None:
    ...
    def test_log_api_call_handles_missing_name(self, reset_logging: None) -> None:
...
class TestFormatterErrorHandling:
    ...
    def test_json_formatter_invalid_extra_fields_type(
        self, reset_logging: None
    ) -> None:
        ...
        record.created = time.time()
        record.extra_fields = "not a dict"  # type: ignore[assignment]

        # Act & Assert
        with pytest.raises(ValueError, match="extra_fields must be a dictionary"):
            formatter.format(record)

    def test_human_readable_formatter_invalid_extra_fields_type(
        self, reset_logging: None
    ) -> None:
    ...
    def test_json_formatter_with_context(self, reset_logging: None) -> None:
    ...
    def test_human_readable_formatter_with_context(self, reset_logging: None) -> None:
    ...
    def test_json_formatter_without_extra_fields(self, reset_logging: None) -> None:
    ...
    def test_human_readable_formatter_without_extra_fields(
        self, reset_logging: None
    ) -> None:
...
class TestLogContextEdgeCases:
    ...
    def test_log_context_nested_context_preservation(self, reset_logging: None) -> None:
    ...
    def test_log_context_token_reset_on_exception(self, reset_logging: None) -> None:
...
class TestLogApiCallEdgeCases:
    ...
    def test_log_api_call_with_return_value(self, reset_logging: None) -> None:
    ...
    def test_log_api_call_with_exception_chaining(self, reset_logging: None) -> None:
    ...
    def test_log_api_call_with_no_args(self, reset_logging: None) -> None:
    ...
    def test_log_api_call_with_complex_args(self, reset_logging: None) -> None:
